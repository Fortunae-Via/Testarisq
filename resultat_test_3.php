	...
	<div class="div_page">
		...
		<section id = "sect">
			<div class="resultat">
				...
				<p>Test visuel à une lumière en extérieur :<span class="resultat_test">reconnaissance des lumières dans un intervalle de 1 à 6 secondes.</span></p>
				<p>Fréquence cardiaque :<span class="resultat_test">88 bpm</span></p>
				<p>Température de la peau :<span class="resultat_test">36,9°C</span></p>
