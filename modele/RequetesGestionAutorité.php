...
function MiseAJour_autorite($bdd, $nom,$type,$id){
	...
	$update = $bdd->prepare("UPDATE autorite SET NomDeFamille=?, NomDUsage=?, Prenom1=?, Prenom2=?, Prenom3=?, Sexe=?, Courriel=?, Portable=?, DateNaissance=? WHERE NIR=?");
