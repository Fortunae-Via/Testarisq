	...
	<div class="div_page">
		...
		<div id="ajout" class="bloc ajout">
			...
			<?php 
				...
				require 'vues/BlocAjoutAuto.php'; 
			?>
			</div>
		</div>
		...
		<div id="recherche" class="bloc">
			...
			?>
				<form method="post" action="GestionAutorité">
			<?php
				require 'vues/BlocRechercheAuto.php';

				if ($PageMaximum > 1) {
					echo ('<div class="nav_pages">');
					    AffichageNavigationPages ('GestionAutorité', $PageAffichage, $PageMaximum, $ChampRecherche, $lienSQLFiltres);
					echo('</div>');
				}
				?>
			</div>
